...
export type DestinationKeySpecifier = ('_photoMeta' | 'address' | 'description' | 'guide' | 'hover_description' | 'id' | 'name' | 'photo' | 'website' | DestinationKeySpecifier)[];
...
export type DestinationImageKeySpecifier = ('altText' | 'destination' | 'id' | 'image' | DestinationImageKeySpecifier)[];
...
export type GuideKeySpecifier = ('_destinationsMeta' | 'destinations' | 'id' | 'location_info' | 'name' | 'status' | GuideKeySpecifier)[];
...
export type KeystoneAdminUIFieldMetaKeySpecifier = ('createView' | 'customViewsHash' | 'fieldMeta' | 'isOrderable' | 'itemView' | 'label' | 'listView' | 'path' | 'viewsHash' | KeystoneAdminUIFieldMetaKeySpecifier)[];
...
export type MutationKeySpecifier = ('authenticateUserWithPassword' | 'createDestination' | 'createDestinationImage' | 'createDestinationImages' | 'createDestinations' | 'createGuide' | 'createGuides' | 'createInitialUser' | 'createUser' | 'createUsers' | 'deleteDestination' | 'deleteDestinationImage' | 'deleteDestinationImages' | 'deleteDestinations' | 'deleteGuide' | 'deleteGuides' | 'deleteUser' | 'deleteUsers' | 'endSession' | 'updateDestination' | 'updateDestinationImage' | 'updateDestinationImages' | 'updateDestinations' | 'updateGuide' | 'updateGuides' | 'updateUser' | 'updateUsers' | MutationKeySpecifier)[];
...
export type QueryKeySpecifier = ('Destination' | 'DestinationImage' | 'Guide' | 'User' | '_DestinationImagesMeta' | '_DestinationsMeta' | '_GuidesMeta' | '_UsersMeta' | '_allDestinationImagesMeta' | '_allDestinationsMeta' | '_allGuidesMeta' | '_allUsersMeta' | '_ksListsMeta' | 'allDestinationImages' | 'allDestinations' | 'allGuides' | 'allUsers' | 'appVersion' | 'authenticatedItem' | 'keystone' | QueryKeySpecifier)[];
...
export type UserKeySpecifier = ('email' | 'id' | 'magicAuthIssuedAt' | 'magicAuthRedeemedAt' | 'magicAuthToken_is_set' | 'name' | 'passwordResetIssuedAt' | 'passwordResetRedeemedAt' | 'passwordResetToken_is_set' | 'password_is_set' | UserKeySpecifier)[];
...
export type StrictTypedTypePolicies = {
	...
	Destination?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | DestinationKeySpecifier | (() => undefined | DestinationKeySpecifier),
		fields?: DestinationFieldPolicy,
	},
	DestinationImage?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | DestinationImageKeySpecifier | (() => undefined | DestinationImageKeySpecifier),
		fields?: DestinationImageFieldPolicy,
	},
	Guide?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | GuideKeySpecifier | (() => undefined | GuideKeySpecifier),
